...
st._config.set_option('theme.secondaryBackgroundColor', "#4287fa")
...
def icon(emoji: str) -> None:
    ...
    st.write(
        f'<span style="font-size: 78px; line-height: 1">{emoji}</span>', unsafe_allow_html=True
        )
icon ("🔄")
...
# Initialze  chat history and selected model
...
<div style='text-align: center;'>
  <p>Developed with ❤️ by Apurva</p>
</div>
"""
